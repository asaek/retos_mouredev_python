...
async def asyncrono(numero1: int, numero2: int, milisegundos: int) -> int:
  print('la espera.....')
  await asyncio.sleep(delay=(milisegundos / 1000))
  print(f'la suma es {numero1+numero2}')


if __name__ == '__main__':
  asyncio.run(asyncrono(numero1=2, numero2= 3, milisegundos= 1500))
  print('Ya paso')